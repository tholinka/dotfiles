...
(( $+commands[glances] )) && alias glances="nice -19 glances -t 5 --disable-check-update"

(( $+commands[htop] )) && alias htop="nice -19 htop"
(( $+commands[top] )) && alias top="nice -19 top"
# make iotop easier to use
(( $+commands[iotop] )) && alias iotop="sudo nice -19 iotop -Pao"
